...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a
					href="admin1.jsp" class="nav-link">Home</a></li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<!-- Brand Logo -->
			<a href="admin1.jsp" class="brand-link"> <img
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					<div class="image">
						<img src="dist/img/KakaoTalk_20200619_180642584_02.jpg"
               ...
               with font-awesome or any other icon font library -->
						<li class="nav-item has-treeview menu-open"><a href="#"
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a href="./admin1.jsp"
									class="nav-link active"> <i class="far fa-circle nav-icon"></i>
										<p>페이지 관리</p>
								</a></li>
								<li class="nav-item"><a href="./admin2.jsp"
					...
					<div class="row">
						...
						<div class="col-lg-3 col-6">
							...
							<div class="small-box bg-warning">
								...
								<a href="./admin2.jsp" class="small-box-footer">More info <i
									class="fas fa-arrow-circle-right"></i></a>
							</div>
						</div>
						<!-- ./col -->
								...
								<div class="card-body">
									<ul class="todo-list" data-widget="todo-list">
										...
										<li><span class="handle"> <i
											...
											</div> <span class="text">임동민 게이</span> <small
										...
										<li><span class="handle"> <i
											...
											</div> <span class="text">서버 체크</span> <small
