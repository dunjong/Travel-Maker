		...
		<div class="row">
			<div class="col">
				<div class="home_search_container">
					<div class="home_search_title">리뷰 리스트</div>
					<div class="home_search_content">
						<form action="#" class="home_search_form" id="home_search_form">
							...
							<!-- 여기부터 반복처리해야할 부분 -->
							<a href="<c:url value='/TravelMaker/ReviewView.kosmo'/>">
								<div class="reviewInformation">
									<div class="bestReviewAndLikes">
										<img src="<c:url value='/images/goldCrown.png'/>"
											alt="1등">
										<br>
										<img src="<c:url value='/images/likes.png'/>"
											alt="좋아요">
										<br>
										<span>126</span>
										<span>명</span>
									...
									<div class="reviewTextInformation">
										<br>
										<h4>가족끼리 구경하기 좋아요</h4>
										<p>숲이 생각보다 꽤 크고 원숭이가 엄청 많아요 ㅋㅋㅋㅋ 나무들도 넘 멋있고 원숭이도 가까이서보고 중간에 미술관도 한번 구경하고~ 다만 겁나 더워요.... 커피가 비쌈..</p>
									</div>
							...
							<a href="<c:url value='/TravelMaker/ReviewView.kosmo'/>">
								<div class="reviewInformation">
									<div class="bestReviewAndLikes">
										<img src="<c:url value='/images/silverCrown.png'/>"
											alt="2등">
										<br>
										<img src="<c:url value='/images/likes.png'/>"
											alt="좋아요">
									...
									<div class="reviewTextInformation">
										<br>
										<h4>즐거웠습니다.</h4>
										<p>우리들이 보기 편하게 꾸미지 않았지만 원숭이들이 스스로와 터를 잡은 만큼 우리는 그들에게 피해주지 않고 잘 관람하는게 예절이라 생각하고 즐기고 왔습니다.</p>
									</div>
									<div class="reviewMapOrImage">
							...
							<a href="<c:url value='/TravelMaker/ReviewView.kosmo'/>">
								<div class="reviewInformation">
									...
									<div class="reviewTextInformation">
										...
										<p>정말 엄청나게 많은 원숭이들을 볼 수 있고 귀엽다. 정말 많은 원숭이들이 있으며 귀여움. 원숭이들이 장난기가 많다. 덥긴 덥다. 나시 입고 가면 팔이 타는 고통을 느낄 수 있으나 원숭이가 귀여우니 참을 수 있다. 우붓가면 돌아보는데 얼마 안걸리니 꼭 가보길 추천한다.</p>
									</div>
									<div class="reviewMapOrImage">
							...
							<a href="<c:url value='/TravelMaker/ReviewView.kosmo'/>">
								<div class="reviewInformation">
									...
									<div class="reviewTextInformation">
										<br>
										<h4>여전히 좋아요</h4>
										<p>두 번째 방문이네요. 일행이 첫 방문이라 같이 갔는데 여전히 멋진 곳입니다.예전보다 원숭이와 람께 사진을 찍을 수 있는 포인트도 늘어난 것 같습니다.
한번 쯤은 꼭 방문해야 하는 곳인듯 합니다. 물론 원숭이들중에는 관광객들의 가방을 털려고 하거나 시비를 걸 수도 있으니 조심해야 합니다^^</p>
									</div>
									<div class="reviewMapOrImage">
