			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item"><a href="adminCity.kosmo"
							class="nav-link active"> <i class="nav-icon far fa-image"></i>
								<p>도시관리</p>
						</a></li>
				</nav> 
				<!-- /.sidebar-menu -->
			...
			<section class="content">
				<div class="row">
					<div class="col-sm-6">
						<div class="row">
							...
							<div class="col-sm-6">도시 이름</div>
							<div class="col-sm-6">
								<input id="city_name" type="text" name="city_name">
							</div>
							<div class="col-sm-6">명소 이름</div>
							<div class="col-sm-6">
								<input id="spot_name" type="text" name="spot_name">
							</div>
							<div class="col-sm-6">위치 아이디</div>
							<div class="col-sm-6">
								<input id="spot_id" type="text" name="spot_id">
							</div>
							<div class="col-sm-6">위치 위도 경도</div>
							<div class="col-sm-6">
								<input id="spot_latlng" type="text" name="spot_latlng">
							</div>
							<div class="col-sm-6">일차</div>
							<div class="col-sm-6">
								<input id="auto_plan_date" value="1" max="5" min="1"
									type="number" name="auto_plan_date">
							</div>
						</div>
					</div>
					...
					<div class="col-sm-6">
						<br>
						<button class="btn btn-info" onclick="save_auto_spot()">auto_plan행
							추가</button>
					</div>
				</div>
				...
				<div id="infowindow-content">
					<span id="place-name" class="title"></span><br /> <strong>Place
						ID:</strong> <span id="place-id"></span><br /> <span id="place-address"></span>
