		...
		<div class="row">
				<div class="col-sm-8" style="height: 150px; width: 100px; border: 1px red solid">
					<div class="row" style="text-align:center">
						...
						<div class="col-md-3" style="height: 90px; width: 40px"><Strong>오전8:30</Strong><br>ICN</div>
				...
				<div class="col-md-12" style="height: 90px; width: 40px; text-align:center">div1</div>
				<div class="col-md-12" style="height: 90px; width: 40px; text-align:center">div1</div>
				</div>
			</div>
	</div>
					...
					<div class="owl-carousel owl-theme testimonials_slider">
						...
						<div class="owl-item text-center">
							<div class="testimonial">Lorem ipsum dolor sit amet,
								consectetur adipiscing elit. lobortis dolor. Cras placerat
								lectus a posuere aliquet. Curabitur quis vehicula odio.</div>
				...
				<div class="news_container">
					...
					<div
						...
						<div class="news_post_content">
							...
							<div class="news_post_text">
								<p>Pellentesque sit amet elementum ccumsan sit amet mattis
									eget, tristique at leo. Vivamus massa.Tempor massa et laoreet.</p>
							</div>
						</div>
					</div>
						...
						<div class="news_post_content">
							...
							<div class="news_post_text">
								<p>Tempor massa et laoreet malesuada. Pellentesque sit amet
									elementum ccumsan sit amet mattis eget, tristique at leo.</p>
							</div>
						</div>
					</div>
					...
					<div
						...
						<div class="news_post_content">
							...
							<div class="news_post_text">
								<p>Vivamus massa.Tempor massa et laoreet malesuada. Aliquam
									nulla nisl, accumsan sit amet mattis.</p>
							</div>
						</div>
					</div>
			...
			<div class="col-xl-4">
				<div class="travello">
					<div class="background_image"
						style="background-image: url(images/travello.jpg)"></div>
					...
					<div class="travello_container">
						<div
							...
							<a href="#"> <span class="travello_title">Get a 20%
									Discount</span> <span class="travello_subtitle">Buy Your
									Vacation Online Now</span>
							</a>
						</div>
					</div>
				</div>
